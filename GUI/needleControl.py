...
def liquidFrame(self):
    ...
    self.LeftButton_w = canvasL.create_window(50,275,window=self.LeftButton)
    ...
    self.RightButton_w = canvasL.create_window(200,275,window=self.RightButton)
    ...
    self.UpButton_w = canvasL.create_window(125,240,window=self.UpButton)
    ...
    self.DownButton_w = canvasL.create_window(125,305,window=self.DownButton)
    ...
    self.BackwardButton_w = canvasL.create_window(300,275,window=self.BackwardButton)
    ...
    self.ForwardButton_w = canvasL.create_window(300,225,window=self.ForwardButton)
    ...
    self.HomeNeedleButton_w = canvasL.create_window(300,325,window=self.HomeNeedleButton)
